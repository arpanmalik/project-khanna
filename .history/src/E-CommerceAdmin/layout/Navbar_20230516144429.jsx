...
const Navbar = ({ hamb, setHamb }) => {
  return (
    <>
      ...
      <Dropdown.Menu>
        <Dropdown.Item>Update Profile <i className="fa-solid fa-user"></i> </Dropdown.Item>
        <Dropdown.Item>Logout <i className="fa-solid fa-right-from-bracket"></i> </Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
          </figcaption>
        </section>
