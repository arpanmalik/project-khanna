  ...
  const data = [
    {
      ...
      description : "OnePlus Bullets Z2 Bluetooth Wireless in Ear Earphones with Mic, Bombastic Bass - 12.4 Mm Drivers, 10 Mins Charge - 20 Hrs Music, 30 Hrs Battery Life (Magico Black)" , 
      added : "React"
    }
  ]
                  ...
                  <tbody>
                    {slicedData?.map((i, index) => (
                      <tr key={index}>
                        ...
                        <td>{i.description.substring(0,20) + " ..."} </td>
                        <td>{i.added} </td>
                        <td>
                          {" "}
                          <span className="flexCont">
